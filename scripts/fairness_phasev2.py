# Auto-generated from fairness_phasev2.ipynb
...
for col in cat_cols:
    df_clean[col] = pd.Categorical(df_clean[col]).codes.astype(float)
...
# %%
train_output_path = f'{OUTPUT_DIR}/train_dir_repaired_lambda{int(SELECTED_LAMBDA * 10):02d}.csv'
